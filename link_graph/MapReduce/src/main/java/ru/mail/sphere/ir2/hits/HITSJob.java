...
public class HITSJob extends Configured implements Tool {
    ...
    private Job getJobConf(String input, String output, int currentIteration) throws IOException {
        ...
        job.setJobName(String.format("HITS. Iteration=%02d", currentIteration));
        ...
        if (currentIteration > 0) {
            ...
            job.setMapperClass(HITSMapperInit.class);
            job.setReducerClass(HITSReducerInit.class);
        }
    ...
    public int run(String[] args) throws Exception {
        ...
        JobControl control = new JobControl(HITSJob.class.getCanonicalName());
